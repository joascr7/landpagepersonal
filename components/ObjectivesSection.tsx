  ...
  const objectives = [
    {
      ...
      img: "https://images.unsplash.com/photo-1518310383802-640c2de311b2?auto=format&fit=crop&w=500&q=80", // Foto profissional de treino
    },
    {
      title: "Hipertrofia",
        ...
        {objectives.map((obj, index) => (
          <div key={index} className="bg-neutral-900 border border-neutral-800 rounded-2xl overflow-hidden flex flex-col">
            ...
            <div className="p-8 flex-1 flex flex-col">
              ...
              <span className="text-amber-500 text-sm font-semibold mb-4 inline-block">Saiba como</span>
              <p className="text-neutral-300 font-medium mb-4 text-sm">{obj.description}</p>
              <p className="text-neutral-400 text-xs leading-relaxed space-y-2 flex-1 pt-4 border-t border-neutral-800/50">
                {obj.details}
              </p>
            </div>
          </div>
