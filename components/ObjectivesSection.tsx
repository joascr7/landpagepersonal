"use client"; // Essencial para habilitar o clique e gerenciamento de estado no Next.js App Router
...
export default function ObjectivesSection({ cliente }: ObjectivesSectionProps) {
  ...
  // Verifica o nicho usando o objeto protegido
  const ehEstetica = clienteValido.nicho === "estetica";

  // Captura a cor do banco ou define o padrão baseado no nicho
  const corDefinida = clienteValido.tema_cor || (ehEstetica ? "pink" : "amber");

  // Estado para gerenciar de forma independente quais cards estão abertos pelo índice
  ...
  const mapasDeCores: Record<string, any> = {
    blue: {
      linha: "bg-blue-500",
      textoSaibaComo: "text-blue-500",
    },
    purple: {
      linha: "bg-purple-500",
      textoSaibaComo: "text-purple-500",
    },
    pink: {
      linha: "bg-pink-500",
      textoSaibaComo: "text-pink-500",
    },
    amber: {
      linha: "bg-amber-500",
      textoSaibaComo: "text-amber-500",
    },
  };
  ...
  // 🔥 OBJETIVOS/SERVIÇOS DINÂMICOS: Agora as imagens também mudam pelo Supabase!
  const objectives = ehEstetica ? [
    {
      ...
      img: clienteValido.img_objetivo_1 || "https://images.unsplash.com/photo-1604654894610-df63bc536371?auto=format&fit=crop&w=500&q=80",
    },
    {
      ...
      img: clienteValido.img_objetivo_2 || "https://images.unsplash.com/photo-1632345031435-8797b2d58045?auto=format&fit=crop&w=500&q=80",
    },
    {
      ...
      img: clienteValido.img_objetivo_3 || "https://images.unsplash.com/photo-1607779097040-26e80aa78e66?auto=format&fit=crop&w=500&q=80",
    },
  ] : [
    {
      title: "Emagrecimento",
      ...
      img: clienteValido.img_objetivo_1 || "https://images.unsplash.com/photo-1518310383802-640c2de311b2?auto=format&fit=crop&w=500&q=80",
    },
    {
      title: "Hipertrofia",
      description: "Pra quem está satisfeito com o percentual of gordura e quer subir medidas e massa muscular.",
      ...
      img: clienteValido.img_objetivo_2 || "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=500&q=80",
    },
    {
      ...
      img: clienteValido.img_objetivo_3 || "https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?auto=format&fit=crop&w=500&q=80",
    },
  ];
          ...
          return (
            <div key={index} className="bg-neutral-900 border border-neutral-800 rounded-2xl overflow-hidden flex flex-col">
              <div className="h-48 w-full relative">
                {/* 🔥 A foto agora carrega dinamicamente a coluna correspondente */}
