        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" h="16" fill="currentColor" viewBox="0 0 16 16" className="text-neutral-400 group-hover:text-green-500 transition-colors">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" h="16" fill="currentColor" viewBox="0 0 16 16" className="text-neutral-400 group-hover:text-red-400 transition-colors">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <a 
                  ...
                  title="Instagram"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" h="18" fill="currentColor" viewBox="0 0 16 16">
